...
if [ $# -lt 5 ]; then
	...
	echo "Sample usage: ./report-arith-adapters.sh /home/smccaman/vaibhav 1 25 32 13.log";
	echo "Sample usage: ./report-arith-adapters.sh /home/smccaman/vaibhav 1 25 32 13.log 1 #deletes existing adapter lists";
	exit 1;
fi

...
int wrap_f1(argret ad, int a, int b, int c, int d, int e, int f,
  ...
  for(int i=0;i<13; i++) {
    ...
    case 13: f2args[i] = convert32to32s(f1args[ad.a_ad[i].var_val]); break;
...
int wrap_f2(argret ad, int a, int b, int c, int d, int e, int f,
	     int g, int h, int _i, int j, int k, int l, int m) {
  int f1args[13]={a, b, c, d, e, f,g,h,_i,j,k,l,m};
  int f2args[13];
  ...
  int ret_val = f2(f2args[0], f2args[1], f2args[2],
		    f2args[3], f2args[4], f2args[5],
		    f2args[6], f2args[7], f2args[8],
		    f2args[9], f2args[10], f2args[11],
		    f2args[12]);
...
bool compare(argret ad1, argret ad2) {
  ...
  for(j=0; j<MAX_TESTS; j++) {
    ...
    //fflush(stdout);
    int r1, r2;
    r1 = wrap_f1(ad1, a0, a1, a2, a3, a4, a5,
		 a6, a7, a8, a9, a10, a11, a12);
    // printf("Completed f1\n");
    // fflush(stdout);
    // printf("Starting f2\n");
    // fflush(stdout);
    r2 = wrap_f2(ad2, a0, a1, a2, a3, a4, a5,
		 a6, a7, a8, a9, a10, a11, a12);
    // printf("Completed f2\n");
    // fflush(stdout);
    if (r1==r2) {
